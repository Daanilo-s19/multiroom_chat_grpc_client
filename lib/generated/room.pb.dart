...
class ListUser extends $pb.GeneratedMessage {
  ...
  factory ListUser.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ListUser.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  ListUser copyWith(void Function(ListUser) updates) =>
      super.copyWith((message) => updates(message as ListUser))
          as ListUser; // ignore: deprecated_member_use
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'chat'),
      createEmptyInstance: create)
    ..aOM<User>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'user',
        subBuilder: User.create)
    ..aOS(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'message')
    ..aOM<$1.Room>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'room',
